                    ...
                    userData += `
                        <div class='relative flex w-full flex-col items-center justify-center py-2'>
                            <div class='relative h-16 w-16 flex-shrink-0 flex-grow-0'>
                                ...
                                ${listAllOptions.userRole == 'admin' ? `<svg class='absolute bottom-0 rounded-full bg-colorBackground text-colorKey ltr:right-0 rtl:left-0 dark:bg-colorColorModeDarkBackground dark:text-colorColorModeDarkKey' height='18' viewBox='0 0 24 24' width='18' title='Administrator' fill='currentColor'>${options.icons.iconVerified}</svg>` :  ''}
                            </div>
